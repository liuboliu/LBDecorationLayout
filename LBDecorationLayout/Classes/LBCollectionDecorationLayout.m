...
#import "LBCollectionDecorationLayout.h"
//#import "VVCategoryBannerDecorationView.h"
#import "LBBaseCollectionDecorationView.h"
// 判断反向布局
...
@interface LBCollectionDecorationLayout ()
...
@implementation LBCollectionDecorationLayout
    ...
    if (numberOfSections > 0) {
        ...
        if (self.vvDelegate && [self.vvDelegate respondsToSelector:@selector(decorationViewClassOfSection:)]) {
            for (NSInteger section = 0; section < numberOfSections; section++) {
                ...
                if ([decorationViewClass isSubclassOfClass:[LBBaseCollectionDecorationView class]]
...
- (CGRect)decrationViewFrameForSection:(NSInteger)section {
    ...
    if (self.scrollDirection == UICollectionViewScrollDirectionVertical) {
        ...
        decrationFrame.size.width = CGRectGetWidth(self.collectionView.bounds);
    } else {
        decrationFrame.size.height = CGRectGetHeight(self.collectionView.bounds);
